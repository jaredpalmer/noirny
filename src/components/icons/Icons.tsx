...
export class ArrowSubmit extends React.PureComponent<any> {
  render() {
    const { className } = this.props;
...
export class Cross extends React.PureComponent<any> {
  render() {
    const { className } = this.props;
...
export class Paperclip extends React.PureComponent<any> {
  render() {
    const { className } = this.props;

    return (
      <svg className={className} data-type="paperclip" viewBox="0 0 37 100">
        <path
